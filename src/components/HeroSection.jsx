  ...
  return (
    <div id="home" className="relative bg-[url('/homeScreenbg.png')] bg-cover bg-center bg-no-repeat w-full h-full">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-6 text-center">
        <h1 className="text-2xl w-[300px] md:w-auto sm:text-3xl md:text-7xl lg:text-4xl xl:text-6xl 2xl:text-[60px] font-extrabold text-white lg:leading-[45px] xl:leading-[60px] 2xl:leading-[68px] mb-10">
          A New Standard Designed for a<br />
          Longer, Healthier Life.
        </h1>
        
        <p className="text-gray-200 text-base md:text-xl lg:text-base xl:text-xl max-w-3xl xl:max-w-5xl mb-10">
