  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-8 right-8 z-50 w-14 h-14 bg-[#25D366] rounded-full flex items-center justify-center shadow-lg hover:scale-110 transition-transform duration-300"
            ...
            <div className="border-t border-white/10 pt-8">
              <div className="flex flex-col md:flex-row justify-between items-center gap-6">
                <div className="text-sm text-gray-400 text-center md:text-left">
                  <p>© FITTERIFY 2025. All rights reserved</p>
                ...
                <div className="flex gap-3">
                  ...
                  <button 
                    onClick={() => handleNavigation("https://www.facebook.com/profile.php?id=100083752502766&mibextid=wwXIfr&mibextid=wwXIfr")}
                    className="w-10 h-10 rounded-full bg-white/10 hover:bg-white/20 flex items-center justify-center transition-colors"
                    aria-label="Facebook"
                  >
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
