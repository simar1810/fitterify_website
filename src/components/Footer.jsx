  ...
  return (
    <footer id="contact" className="w-full bg-black text-white px-6 md:px-20 py-16">
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start gap-10">
        ...
        <div className="w-20 h-20 md:w-28 md:h-28 bg-[#EE3324] rounded-full flex items-center justify-center">
          <div className="w-15 h-15 md:w-21 md:h-21 bg-transparent rounded-full flex items-center justify-center ring-2 ring-white">     
            <div className="w-10 h-10 rounded-full md:w-15 md:h-15 bg-white flex items-center justify-center">
                <Image src="/footer-logo.png" alt="footer-logo" width={500} height={500} className="w-5 md:w-10"/>
            </div>
          </div>            
        </div>
      </div>
