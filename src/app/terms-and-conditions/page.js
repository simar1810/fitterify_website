    ...
    <section className="bg-[#FAFAFA] min-h-screen py-12 px-6 sm:px-10 lg:px-20 xl:px-32 overflow-hidden">
      <div className="max-w-5xl mx-auto bg-white shadow-md rounded-2xl p-6 sm:p-10 lg:p-12 border border-gray-100">
        <div className="text-center mb-10">
          <h1 className="w-full md:w-sm mx-auto text-3xl sm:text-4xl font-bold text-[#3D3D3D] mb-3 border-b-4 border-[#07363C]">
            Terms & Conditions
          </h1>
        ...
        <div className="space-y-6 text-[#494848] leading-relaxed text-sm sm:text-base">
          ...
          <p>Welcome to Fitterify!</p>

          <p>
            These terms and conditions outline the rules and regulations for the use
            of Fitterify&apos;s website, located at {" "}
            <a
          ...
          <p>
            ...
            conditions. Do not continue to use Fitterify if you do not agree to
          ...
          <p>
            ...
            &quot;We&quot;, &quot;Our&quot;, and &quot;Us&quot; refer to Fitterify. &quot;Party&quot;, &quot;Parties&quot;, or &quot;Us&quot; refer
          ...
          <h3 className="text-lg font-semibold text-[#3D3D3D] border-l-4 border-[#07363C] pl-3">
            Cookies
          </h3>

          <p>
            We employ the use of cookies. By accessing Fitterify, you agree to
            use cookies in accordance with Fitterify&apos;s Privacy Policy.
          </p>
          ...
          <p>
            Unless otherwise stated, Fitterify and/or its licensors own the
            intellectual property rights for all material on Fitterify. All
            intellectual property rights are reserved. You may access this from
            Fitterify for your own personal use subject to the restrictions set
            in these terms and conditions.
          </p>

          <p>You must not:</p>
          <ul className="list-disc list-inside space-y-1">
            <li>Republish material from Fitterify;</li>
            <li>Sell, rent, or sub-license material from Fitterify;</li>
            <li>Reproduce, duplicate, or copy material from Fitterify;</li>
            <li>Redistribute content from Fitterify.</li>
          </ul>
          ...
          <p>
            ...
            exchange opinions and information in certain areas of the website. Fitterify does not filter, edit, publish, or review Comments prior to their
            presence on the website. Comments do not reflect the views or opinions
            of Fitterify, its agents, and/or affiliates. Comments reflect the
            views and opinions of the person who posts them. To the extent permitted
            by applicable law, Fitterify shall not be liable for the Comments or
          ...
          <p>
           Fitterify reserves the right to monitor all Comments and to remove
          ...
          <p>
            You hereby grant Fitterify a non-exclusive license to use, reproduce,
          ...
          <p>
            ...
            the hyperlink compensates the absence of Fitterify; and (d) the link
          ...
          <p>
            No use of Fitterify&apos;s logo or other artwork will be allowed for
